<script lang="ts">
	...
	async function handleDelete() {
		...
		selectedCarrier = {};
		showSuccess('Metodo de envio eliminado');
		refetch(['carriers']);
		show3 = false;
	}
</script>
...
<CusTable>
	<TableHeader>
		<OptionsHead />
		<TableHead class="w-full">Metodo de envio</TableHead>
	</TableHeader>
	<TableBody>
...
<DeletePopUp bind:show={show3} text="Eliminar Metodo de envio" deleteFunc={handleDelete} />
